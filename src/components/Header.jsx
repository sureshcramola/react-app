...
class Header extends Component {
  ...
  renderForgotModal() {
    if (this.state.forgotModalVisibility) {
      return (
        <Modal
          isOpen={this.state.forgotModalVisibility}
          className="modal-forget"
          centered="true"
        >
          <ModalBody>
            <div className="text-center">
              ...
              <p className="forget-subtitle">
                No worries ! Enter yout email and we will send you a reset link
              </p>
            </div>
            <div className="row">
          ...
          <ModalFooter>
            ...
            <button
              color="danger"
              onClick={e => this.modalSwap("login")}
  ...
  renderLoginModal() {
    if (this.state.loginModalVisibility) {
      return (
        <Modal
          isOpen={this.state.loginModalVisibility}
          className=""
          centered="true"
        >
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="form-group">
                  ...
                  <input
                    type={
                      this.state.isLoginPasswordVisible ? "text" : "password"
                    }
                  ...
                  <div
                    ...
                    onClick={() =>
                      this.setState({
                        isLoginPasswordVisible: !this.state
          ...
          <ModalFooter className="flex-row justify-content-between">
            <div className="">
              <span
                ...
                onClick={e => this.modalSwap("forgot")}
              >
                Forgot Password ?
              </span>
            </div>
  ...
  renderSignupModal() {
    if (this.state.signupModalVisibility) {
      return (
        <Modal
          isOpen={this.state.signupModalVisibility}
          className=""
          centered="true"
          backdrop="false"
        >
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="form-group">
                    ...
                    <input
                      type={
                        this.state.isSignupPasswordVisible ? "text" : "password"
                      }
                      value={this.state.team}
                      onChange={this.handleChangeTeam}
                      className="border-input"
      ...
      >
        ...
        <div className="rightBar ml-auto d-flex flex-row justify-content-end">
          ...
          <div className="left-links">
            <div>
              <Link className="nav-links underline-none" to="/about">
                About Us
              </Link>
              <Link className="nav-links underline-none" to="/blog">
                Blog
              </Link>
              {/* <Link className="nav-links underline-none" to="/account">Profile</Link> */}
              <Link className="nav-links underline-none" to="/contact">
                Contact Us
              </Link>
            </div>
          </div>
          ...
          <div
            className={`user-profile-wrapper ${
              isUserLoggedIn
                ? "d-flex flex-row align-items-center show"
                : "hide"
            }`}
          >
            ...
            <div
              className={`dropdown-card dropdown-transition ${
                this.state.isUserProfileCardOpen ? "dropdown--toggled" : ""
              }`}
              ref="dropdownProfileCard"
            >
              <ul>
                <li>
                ...
                <li className="border-list-bottom list-gap-btm" />
                ...
                <li className="border-list-bottom list-gap-top" />
                <li className="dropdown-link">
                  <a
                    href="#"
                    className="d-inline-flex flex-row align-items-center"
          ...
          <div
            className={`user-login-signup-wrapper ${
              isUserLoggedIn ? "hide" : "d-flex align-items-center"
            }`}
          >
            <button className="main-btn-sm" onClick={this.toggleLoginModal}>
              Log in
            </button>
            <button className="main-btn-sm" onClick={this.toggleSignupModal}>
              Sign up
            </button>
          </div>
